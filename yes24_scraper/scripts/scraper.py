from utils import get_url_from_page, get_book_info
...
# URL 설정
SEARCH_URL = 'https://www.yes24.com/Product/Search?domain=BOOK&query=%25ED%2581%25B0%25EA%25B8%2580%25EC%259E%2590%25EB%258F%2584%25EC%2584%259C&page={}&size=24&statGbYn=Y'
...
def scrape_books(start_page, end_page):
    ...
    # filename = f"{DATA_DIR}/books_{start_page}_{end_page}.json"
